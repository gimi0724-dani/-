...
export function Header({ year, month, income, expense, net, onPrev, onNext, onChart, onReport, onSettings }: Props) {
  ...
  return (
    <div className="shrink-0 px-4 pt-4 pb-[6px]" style={{ borderBottom: '1px solid #333333' }}>
      {/* 월 이동 + 우상단 버튼 */}
      ...
      <div className="flex gap-3">
        <div className="flex-1 rounded-xl" style={{ background: '#252525', paddingLeft: 10, paddingRight: 6, paddingTop: 9, paddingBottom: 9 }}>
